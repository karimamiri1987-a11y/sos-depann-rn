      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.content}>
        ...
        <View style={styles.permCard}>
          {PLATS_PERMANENTS.map((p, i) => (
            <View key={p.id} style={[styles.permRow, i < PLATS_PERMANENTS.length - 1 && styles.permRowBorder]}>
        ...
        <TouchableOpacity style={styles.ctaBtn} onPress={() => navigation.navigate('TableReservation')} activeOpacity={0.9}>
          <LinearGradient colors={[ODT.primary, '#2D5A42']} style={styles.ctaGradient} start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }}>
        ...
        <View style={styles.dessertCard}>
          ...
          {DESSERTS.suggestions.map(d => <DessertRow key={d.id} item={d} />)}
          <View style={styles.dessertDivider} />
          <Text style={styles.dessertGroupTitle}>🍦 Les grands classiques</Text>
          {DESSERTS.classiques.map(d => <DessertRow key={d.id} item={d} />)}
        </View>

        <Text style={styles.footnote}>🌿 Cuisine maison · ☎ {CAFE_INFO.tel}</Text>
...
const styles = StyleSheet.create({
  ...
  headerContent: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start', paddingHorizontal: 20, paddingTop: 12 },
  ...
  logoCircle: { width: 52, height: 52, borderRadius: 26, backgroundColor: 'rgba(255,255,255,0.15)', alignItems: 'center', justifyContent: 'center' },
  logoEmoji: { fontSize: 26 },
  content: { padding: 16 },
  infoCard: { backgroundColor: ODT.white, borderRadius: 14, padding: 14, marginBottom: 18, gap: 8, shadowColor: '#000', shadowOpacity: 0.05, shadowRadius: 6, shadowOffset: { width: 0, height: 2 }, elevation: 2 },
  ...
  dayCard: { backgroundColor: ODT.white, borderRadius: 14, padding: 14, marginBottom: 10, borderLeftWidth: 4, borderLeftColor: ODT.gold, shadowColor: '#000', shadowOpacity: 0.05, shadowRadius: 6, shadowOffset: { width: 0, height: 2 }, elevation: 2 },
  dayHeader: { flexDirection: 'row', alignItems: 'baseline', gap: 8, marginBottom: 10 },
  ...
  courseTag: { backgroundColor: ODT.lightGray, borderRadius: 6, paddingHorizontal: 8, paddingVertical: 3, minWidth: 52, alignItems: 'center' },
  ...
  permCard: { backgroundColor: ODT.white, borderRadius: 14, padding: 4, marginBottom: 18, shadowColor: '#000', shadowOpacity: 0.05, shadowRadius: 6, shadowOffset: { width: 0, height: 2 }, elevation: 2 },
  ...
  ctaBtn: { borderRadius: 16, overflow: 'hidden', marginBottom: 22, shadowColor: ODT.primary, shadowOpacity: 0.3, shadowRadius: 10, shadowOffset: { width: 0, height: 4 }, elevation: 5 },
  ctaGradient: { flexDirection: 'row', alignItems: 'center', padding: 18, paddingHorizontal: 20 },
  ...
  dessertCard: { backgroundColor: ODT.white, borderRadius: 14, padding: 16, marginBottom: 18, shadowColor: '#000', shadowOpacity: 0.05, shadowRadius: 6, shadowOffset: { width: 0, height: 2 }, elevation: 2 },
  ...
  priceBadge: { backgroundColor: '#EAF5EC', borderRadius: 8, paddingHorizontal: 10, paddingVertical: 5 },
  priceText: { fontSize: 13, fontWeight: '900', color: ODT.green },
  footnote: { textAlign: 'center', fontSize: 12, color: ODT.gray, lineHeight: 18, fontStyle: 'italic' },
});
