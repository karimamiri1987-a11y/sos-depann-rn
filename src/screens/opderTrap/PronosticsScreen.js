...
const ACTIVE_PRONOSTICS = [
  {
    ...
    badge: '🟢 En cours',
    screen: 'TDFHome',
    desc: '20 coureurs · 21 étapes · 5pts / 3pts / 1pt',
  },
];
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.content}>
        ...
        <View style={styles.rulesCard}>
          ...
          <View style={styles.rulesGrid}>
            <RuleStep num="1" text="Inscrivez les participants" />
...
function PointChip({ pts, label, color }) {
  return (
    <View style={[styles.ptChip, { backgroundColor: color }]}>
      <Text style={styles.ptVal}>{pts}pts</Text>
      <Text style={styles.ptLabel}>{label}</Text>
    </View>
  );
}
